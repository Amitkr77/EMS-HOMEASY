      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-md transition-all flex items-center gap-5">
            ...
            <div>
              <p className="text-xs font-semibold text-slate-500 tracking-widest uppercase">PRESENT THIS MONTH</p>
              <p className="text-3xl font-bold text-slate-900 mt-1">
                {data?.thisMonth?.present || 0}/{data?.thisMonth?.totalWorkingDays || 0}
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-md transition-all flex items-center gap-5">
            ...
            <div>
              <p className="text-xs font-semibold text-slate-500 tracking-widest uppercase">ATTENDANCE RATE</p>
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-100 hover:shadow-md transition-all flex items-center gap-5">
            ...
            <div>
              <p className="text-xs font-semibold text-slate-500 tracking-widest uppercase">LEAVE BALANCE</p>
              <p className="text-3xl font-bold text-slate-900 mt-1">
        ...
        <div className={`rounded-2xl p-6 md:p-8 border mb-8 transition-all ${
          shiftStatus === "active" 
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 mt-1">Check-in or check-out</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 mt-1">View assigned work</p>
              </div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 mt-1">Stay updated with the latest company news and updates from admin</p>
              </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm">
          <div className="flex items-center gap-5">
            ...
            <div className="hidden md:block text-right">
              <div className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">Portal Access</div>
              <div className="font-medium text-slate-700 text-sm mt-1">Employee Portal</div>
            </div>
          </div>
        </div>
      </div>
